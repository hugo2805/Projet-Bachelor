...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void Update()
    {
        if (UpdatePadState())
        {
            ...
            yaw = transform.localEulerAngles.y + rStick.fx * 5;
            ...
            if (npadState.GetButton(NpadButton.A) && isGrounded)
            {
                Jump();
            }
            ...
            Vector3 targetVelocity = new Vector3(lStick.fx*5, 0, lStick.fy*5);
